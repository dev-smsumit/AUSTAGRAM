...
export function Hero() {
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto flex h-[100vh] max-w-7xl items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl">          
          ...
          <h1 className="mt-3 max-w-2xl font-heading text-3xl leading-[0.9] text-white drop-shadow-[0_12px_32px_rgba(25,50,84,0.18)] sm:text-5xl lg:text-[74px]">
        ...
        <div className="mt-14 flex flex-col gap-4 self-start sm:flex-row sm:self-end">
          {heroStats.map((stat) => (
            <GlassCard
              key={stat.label}
              className="min-w-32 animate-float bg-white/18 px-6 pb-8 pt-4 text-center text-white"
            >
